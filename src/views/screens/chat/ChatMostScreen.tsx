...
const ChatMessageBox = styled(TouchableOpacity)<ChatMessageProps>`
...
const ChatMostScreen = ({ navigation }: ChatMostScreenProps) => {
    ...
    const handleQuestionPress = (questionText: string) => {
                ...
                >
                    ...
                    >
                        ...
                        {messages.map((message) => (
                            <ChatMessageBox key={message.id} isUser={message.isUser}>
